...
export type Transaction = AccountDelete | AccountSet | AMMBid | AMMDelete | AMMDeposit | AMMCreate | AMMVote | AMMWithdraw | CheckCancel | CheckCash | CheckCreate | Clawback | DepositPreauth | EscrowCancel | EscrowCreate | EscrowFinish | NFTokenAcceptOffer | NFTokenBurn | NFTokenCancelOffer | NFTokenCreateOffer | NFTokenMint | OfferCancel | OfferCreate | Payment | PaymentChannelClaim | PaymentChannelCreate | PaymentChannelFund | SetRegularKey | SignerListSet | TicketCreate | TrustSet | XChainAddAccountCreateAttestation | XChainAddClaimAttestation | XChainClaim | XChainCommit | XChainCreateBridge | XChainCreateClaimID | XChainAccountCreateCommit | XChainModifyBridge;
